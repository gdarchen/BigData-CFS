...
class Server(object):
    ...
    def find_token_infos_in_dict(self, token):
        ...
        it is returned. Else, '-1' is returned.
    ...
    def get_tweets_valence(self):
        ...
        general_valence = {}
        for tweet in self.tweets:
            general_valence[tweet.text] = self.get_tweet_valence(tweet.text)[0]
        return general_valence

    @time_and_exception
    def compute_global_tweets_valence(self):
        """
    ...
    def compute_f1_score(self):
        """
        Computes and returns the macro-averaged F1-Score.
        """
        y_true = []
        y_pred =[]
